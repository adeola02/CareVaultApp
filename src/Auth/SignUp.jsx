...
const SignUp = () => {  
  ...
  const validate = () => {  
    const { fullName, passWord, email, dateOfBirth, gender, phoneNumber } = formData;  
      ...
      <div className="signup-wrapper">  
        ...
        <section className="signup-form">  
          ...
          <form onSubmit={handleSubmit}>  
            ...
            <span>password must contain uppercase, lowercase, number & special character</span>
            </div>
                {showPassword ? (  
                  <FaRegEyeSlash onClick={() => setShowPassword(false)} className="password-icon" />  
                ) : (  
                  <FaRegEye onClick={() => setShowPassword(true)} className="password-icon" />  
                )}  
              </div>  
            </label>  
